...
|...|...|...|
|43892|걸음을 바로볼수있어서 너무좋아요 포인트도...|1|
|43893|대박 걸으면 포인트가 쌓인다는게 완전좋네...|1|
|43894|이 앱 진짜 좋네요 건강도 생각하고 포인트...|1|

43895개의 데이터가 있으며 긍정과 부정에 대한 그래프를 그려봤다
<div align="left"><img src="https://github.com/ho0116/korean_project/assets/85285367/eb38c9b0-9da9-4230-b389-4c85183798be" width="500"></div>
긍정은 27444개가 있고, 부정은 16451개의 데이터로 구성되어있다  
<br><br>

- 리뷰 문장 15자 이상 길이의 분포도
<div align="left"><img src="https://github.com/ho0116/korean_project/assets/85285367/a024eee7-94aa-4017-87d3-11980ad5b3e2" width="500"></div>
50자이하에 많은 리뷰가 몰려있다  
<br><br>

### 2.4 학습 데이터
- 랜덤으로 부정 3290개, 긍정추출 3290개 총 6580개 추출

||review|label|
|---|---|---|
|0|보물상자가 안뜨는데 캐쉬적립을 어떻게 하라는...|0|
|1|몇걸음 걸었는지 확인할 때마다 두 걸음식 추가...|0|
|2|업데이트를 너무 자주하시네요|0|
|...|...|...|
|6577|다 좋은데 제발 캐시 받을 때는 광고...|1|
|6578|업데이트를 좀 많이 하는것 같아요|1|
|6579|걷는데 돈을 주네 광고뜨는게 어쩔수 없는건...|1|

- 랜덤으로 부정 3290개, 긍정 5264개 총 8554개 추출
...
|2|업데이트를 너무 자주하시네요|0|
|...|...|...|
|8551|많이 걸었는데 순위권 안에 들었는데 왜...|1|
|8552|다좋은데가끔씩캐시가적립이안되는경우가...|1|
|8553|다 괜찮은데 제 기분탓 일 수도 있는데 제...|1|
